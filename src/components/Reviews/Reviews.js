...
const Reviews = () => {
  ...
  return (
    <div className='pt-24 pb-16' style={{background:'#F9EAEA'}}>
        ...
        <div className= ' flex flex-col md:flex-row md:flex-row review gap-x-4 gap-y-4 drop-shadow-xl'>
           {reviews.map((review)=>
             <div class="max-w-sm rounded  shadow-lg rounded-t-full drop-shadow-xl " style={{boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px'}}>
