  ...
  return (
   <div className=''>
     <div className='w-full' style={{
        backgroundImage:"url(/mostvisitedPlace/ezgif.com-gif-maker.jpg)",
        backgroundPosition: 'center',
        backgroundSize: 'cover',
        height:'80vh' 
    }}>
      <p className='text-2xl text-white font-bold text-center pt-9 pb-10'>Our most visited places</p>
       <div className='flex flex-col md:flex-row lg:flex-row gap-x-5 gap-y-5 px-20 justify-between'>
            <div className="h-48 cursor-auto flex flex-row items-center bg-white rounded-lg border shadow-md  md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
